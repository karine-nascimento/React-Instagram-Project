...
import './Header.css'
import '../Screens/Feed/Layout.css'
import { IconContext } from 'react-icons'
import Perfil5 from '../Screens/Feed/images/perfil5.jpg'
    ...
    return (
        <header className="header">
            ...
            <div className="container">
                ...
                <IconContext.Provider value={{ color: 'rgb(142,142,142)' }}>
                <FiSearch/>
                </IconContext.Provider>
                    <input />
                    <span className='placeholder'>Pesquisar</span>
                </div>
